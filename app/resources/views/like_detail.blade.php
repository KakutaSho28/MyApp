                            ...
                            @foreach($posts as $post)
                                <tr>
                                    ...
                                    @if (!$post->isLikedBy(Auth::id()))
                                        <span class="likes">
                                        <button type="hidden" class="btn like-toggle" data-post-id="{{ $post->id }}"><i class="bi bi-heart-fill"></i></button>
                                        </span><!-- /.likes -->
                                    @else
                                        <span class="likes">
                                            <button type="hidden" class="btn like-toggle liked" data-post-id="{{ $post->id }}"><i class="bi bi-heart-fill"></i></button>
                                        </span><!-- /.likes -->
                                    @endif
                                    </th>
                                    <th scope='col'><a href="{{ route('post.booking',$post['id']) }}"><i class="bi bi-border-width"></i></a></th>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    ...
                    <table class='table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th scope='col'>
                                    <a href="{{ route('post.booking',$booking->post->id) }}"><i class="bi bi-border-width"></i></a>
                                </th>
                            </tr>
                            @endforeach
                        </tbody>
